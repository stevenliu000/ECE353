...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: monitorLock = zeros  (sizeInBytes=28)
	load	[r14+8],r4
	add	r4,28,r4
	mov	7,r3
_Label_208:
	...
	sub	r3,1,r3
	bne	_Label_208
!   monitorLock = _P_Synch_Mutex2
	set	_P_Synch_Mutex2,r1
	load	[r14+8],r2
	store	r1,[r2+28]
! SEND STATEMENT...
...
!   _temp_139 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-52]
!   Move address of _temp_139 [p ] into _temp_140
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-48]
!   Data Move: *_temp_140 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-48],r2
	store	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   _temp_148 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_148 [left ] into _temp_149
!     make sure index expr is >= 0
	load	[r14+-60],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: _temp_147 = *_temp_149  (sizeInBytes=4)
	load	[r14+-28],r1
	load	[r1],r1
	store	r1,[r14+-36]
!   if _temp_147 != 2 then goto _Label_146		(int)
	load	[r14+-36],r1
	mov	2,r2
	cmp	r1,r2
	bne	_Label_146
...
!   _temp_151 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   Move address of _temp_151 [right ] into _temp_152
!     make sure index expr is >= 0
	load	[r14+-64],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   Data Move: _temp_150 = *_temp_152  (sizeInBytes=4)
	load	[r14+-16],r1
	load	[r1],r1
	store	r1,[r14+-24]
!   if _temp_150 != 2 then goto _Label_145		(int)
	load	[r14+-24],r1
	mov	2,r2
	cmp	r1,r2
	bne	_Label_145
...
!   _temp_179 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_178  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_174:
!   Perform the FOR-LOOP termination test
!   if p > _temp_179 then goto _Label_177		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_186 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_186 [p ] into _temp_187
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_185 = *_temp_187  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
