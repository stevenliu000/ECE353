...
!   Call the function
	...
	mov	"\0\0CA",r10
	call	_function_35_ProducerConsumer
! CALL STATEMENT...
!   Call the function
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: _Global_prod = zeros  (sizeInBytes=20)
	set	_Global_prod,r4
	store	r0,[r4]
	store	r0,[r4+4]
	store	r0,[r4+8]
	store	r0,[r4+12]
	store	r0,[r4+16]
!   _Global_prod = _P_Synch_Semaphore
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: _Global_cons = zeros  (sizeInBytes=20)
	set	_Global_cons,r4
	store	r0,[r4]
	store	r0,[r4+4]
	store	r0,[r4+8]
	store	r0,[r4+12]
	store	r0,[r4+16]
!   _Global_cons = _P_Synch_Semaphore
	set	_P_Synch_Semaphore,r1
	set	_Global_cons,r2
	store	r1,[r2]
! SEND STATEMENT...
